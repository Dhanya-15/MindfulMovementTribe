...
export default function Certifications() {
  return (
    <section
      id="certifications"
      className="relative py-16 md:py-24" // overflow-hidden removed so the waves can bleed outside this section
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 relative [perspective:1800px]">
        <motion.div
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-light" style={{ color: "#001532" }}>
              ...
              >
                <div
                  className={`w-full md:w-1/2 flex ${
                    fromLeft ? "md:pr-12 md:justify-end" : "md:pl-12 md:justify-start"
                  }`}
                >
                  <motion.div
                    whileHover={{
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="font-body text-sm sm:text-base" style={{ color: "#132430" }}>{cert.place}</p>
